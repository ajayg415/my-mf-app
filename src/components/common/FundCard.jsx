      ...
      <div className="card-body p-4">
        ...
        <div className="flex flex-col gap-2 bg-base-200/50 rounded-lg p-2.5 mb-3">
           ...
           <div className="flex justify-between items-center text-xs">
              ...
              <div className={`font-bold flex items-center gap-1 ${getColorClass(oneDayChange)}`}>
                 <span>{oneDayChange > 0 ? "+" : ""}{formatMoney(oneDayChange)}</span>
                 <span className="opacity-80 font-medium">({Math.abs(oneDayPercent).toFixed(2)}%)</span>
              </div>
           </div>
